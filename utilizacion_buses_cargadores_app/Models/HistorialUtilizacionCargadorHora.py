...
class HistorialUtilizacionCargadorHora (models.Model):
    ...
    cargador_id = models.ForeignKey(Cargador.Cargador, on_delete=models.CASCADE, to_field='id')
    hora_id = models.ForeignKey(Hora.Hora, on_delete=models.CASCADE, to_field='id')
    bus_id = models.ForeignKey(Bus, on_delete=models.CASCADE, to_field='id', null=True)
